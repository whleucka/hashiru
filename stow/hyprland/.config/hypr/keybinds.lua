...
hl.bind(key(mod, "SHIFT", "T"), hl.dsp.exec_cmd(terminal .. " --class btop -o font_size=11 btop"), { description = "System monitor (btop)" })
hl.bind(key(mod, "SHIFT", "U"), hl.dsp.exec_cmd(terminal .. " -o font_size=11 update-system", { float = true, size = { 900, 600 }, center = true }), { description = "Update system" })
