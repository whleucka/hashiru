...
hl.bind(key(mod, "SHIFT", "U"), hl.dsp.exec_cmd(terminal .. " -o font_size=9 " .. hypr_scripts .. "/update-system", { float = true, size = { 900, 600 }, center = true }), { description = "Update system" })
